...
//Tx Zero
#define TX_EN_DATATYPE BOOL_TYPE
#define TX_EN_VALID_DATA true
#define TX_EN_BLANK_DATA false

//#define MULTI_CH //If defined, 

//Ch0
#define TX_SYMBOL_CH0_MEMBER_NAME symbol_BUNDLE_1_inPort0_re
#define TX_MODTYPE_CH0_MEMBER_NAME modulation_BUNDLE_1_inPort1_re
#define TX_EN_CH0_MEMBER_NAME en_BUNDLE_1_inPort2_re
...
//Ch0
#define RX_PACKED_CH0_MEMBER_NAME dataPacked_BUNDLE_1_outPort0_re
#define RX_VALID_CH0_MEMBER_NAME dataPackedValid_BUNDLE_1_outPort1_re
#define RX_LAST_CH0_MEMBER_NAME dataPackedLast_BUNDLE_1_outPort2_re
